...
import com.zillians.run_zillians_run.zs_flex_project.actions.upload.UploadDialog;
import com.zillians.run_zillians_run.zs_flex_project.actions.upload.UploadZipTool;
		...
		if (selection instanceof IStructuredSelection) {
			Object obj = ((IStructuredSelection) selection).getFirstElement();
				if( obj instanceof IResource )
				{
					...
					UploadZipTool.getInit().setProjectLocation(
