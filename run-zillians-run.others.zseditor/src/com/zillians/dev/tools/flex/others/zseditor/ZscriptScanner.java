...
public class ZscriptScanner extends RuleBasedScanner {
	...
	public ZscriptScanner( ColorManager colorManager ){
		...
		new TextAttribute (colorManager.getColor(ZscriptColorConstants.OBJECT));
		comment = new TextAttribute (colorManager.getColor(ZscriptColorConstants.COMMENT));
		new TextAttribute (colorManager.getColor(ZscriptColorConstants.ANNOTATION));
		new TextAttribute (colorManager.getColor(ZscriptColorConstants.MAIN_OBJECT));
		//设置代码的规则
		setupRules();
	}
